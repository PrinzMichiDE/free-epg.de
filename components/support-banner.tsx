...
import { GiftIcon, HeartIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline';
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg shadow-blue-500/50"
              >
