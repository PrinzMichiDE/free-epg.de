...
export const translations = {
  de: {
    ...
    feature1Desc: 'EPG-Daten für über 13 Länder: Deutschland, USA, UK, Frankreich, Italien, Spanien und mehr',
  ...
  en: {
    ...
    feature1Desc: 'EPG data for over 13 countries: Germany, USA, UK, France, Italy, Spain and more',
  ...
  fr: {
    ...
    feature1Desc: 'Données EPG pour plus de 13 pays: Allemagne, États-Unis, Royaume-Uni, France, Italie, Espagne et plus',
  ...
  es: {
    ...
    feature1Desc: 'Datos EPG para más de 13 países: Alemania, EE.UU., Reino Unido, Francia, Italia, España y más',
